          ...
          <div className="p-6 sm:p-10 overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input required type="text" value={fullName} onChange={(e) => setFullName(e.target.value)} className="w-full bg-soft-grey border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-growth-green/20" placeholder="John Doe" />
              </div>
              ...
              <div className="flex flex-col sm:grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input required type="email" value={emailAddress} onChange={(e) => setEmailAddress(e.target.value)} className="w-full bg-soft-grey border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-growth-green/20" placeholder="john@example.com" />
                </div>
                <div>
                  ...
                  <input required type="tel" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} className="w-full bg-soft-grey border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-growth-green/20" placeholder="+971 ..." />
                </div>
              </div>
              ...
              <div className="flex flex-col sm:grid sm:grid-cols-5 gap-4">
                <div className="sm:col-span-3">
                  ...
                  <input required type="number" value={investmentBudget} onChange={(e) => setInvestmentBudget(e.target.value)} className="w-full bg-soft-grey border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-growth-green/20" placeholder="e.g. 2,000,000" />
                </div>
