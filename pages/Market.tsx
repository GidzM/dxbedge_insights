      ...
      <div className="bg-[radial-gradient(circle_at_top,_rgba(201,168,106,0.16),_transparent_38%),linear-gradient(180deg,_#f8f9fa_0%,_#ffffff_42%,_#f7f4ee_100%)]">
        <section className="relative overflow-hidden border-b border-brand-gold/20 bg-brand-navy text-white">
          <div className="absolute inset-0 opacity-20">
            <div className="absolute -left-24 top-10 h-72 w-72 rounded-full bg-brand-gold blur-3xl" />
            <div className="absolute right-0 top-1/3 h-64 w-64 rounded-full bg-sky-400/20 blur-3xl" />
          </div>
          ...
          <div className="relative mx-auto max-w-7xl px-10 py-20 lg:px-16 lg:py-24">
            <div className="max-w-4xl">
              ...
              <h1 className="max-w-5xl text-4xl font-serif italic text-white sm:text-5xl lg:text-6xl">
                Independent analysis of Dubai's property cycles, supply, demand and emerging communities.
              </h1>
              <p className="mt-6 max-w-3xl text-sm leading-relaxed text-white/80 md:text-base">
                Dubai's property market moves through clear, fundamentals-driven cycles shaped by supply, demand, rental behaviour and long-term community development. Understanding those cycles is essential when evaluating both ready and off-plan opportunities.
              </p>
